function [PrincipalCurvatures,PrincipalDir1,PrincipalDir2,FaceCMatrix,VertexCMatrix,Cmagnitude] = GetCurvaturesAndDerivatives(Faces,Vertices,toggleDerivatives )
%% Summary 
...
[FaceNormals]=CalcFaceNormals(Faces,Vertices);
[VertexNormals,Avertex,Acorner,up,vp]=CalcVertexNormals(Faces,Vertices,FaceNormals);
[FaceSFM,VertexSFM,wfp]=CalcCurvature(Faces,Vertices,VertexNormals,FaceNormals,Avertex,Acorner,up,vp);
[PrincipalCurvatures,PrincipalDir1,PrincipalDir2]=getPrincipalCurvatures(Faces,Vertices,VertexSFM,up,vp);
if toggleDerivatives==1
[FaceCMatrix,VertexCMatrix,Cmagnitude]=CalcCurvatureDerivative(Faces,Vertices,FaceNormals,PrincipalCurvatures,up,vp,wfp);
end
end
